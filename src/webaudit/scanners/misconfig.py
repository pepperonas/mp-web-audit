...
SENSITIVE_PATHS: list[dict] = [
    ...
    {
        "path": "/server.key",
        "titel": "Private Key exponiert",
        "severity": Severity.KRITISCH,
        "beschreibung": "Ein privater Schluessel ist oeffentlich zugaenglich.",
    },
    {
        "path": "/.ssh/id_rsa",
        "titel": "SSH Private Key exponiert",
        "severity": Severity.KRITISCH,
        "beschreibung": "Ein SSH Private Key ist oeffentlich zugaenglich.",
    },
    {
        "path": "/.aws/credentials",
        "titel": "AWS Credentials exponiert",
        "severity": Severity.KRITISCH,
        "beschreibung": "AWS-Zugangsdaten sind oeffentlich zugaenglich.",
        "validate": lambda text: "aws_access_key" in text.lower() or "aws_secret" in text.lower(),
    },
    {
        "path": "/.kube/config",
        "titel": "Kubernetes Config exponiert",
        "severity": Severity.KRITISCH,
        "beschreibung": "Kubernetes-Konfiguration mit Cluster-Zugangsdaten ist zugaenglich.",
        "validate": lambda text: "apiVersion" in text or "clusters" in text,
    },
    {
        "path": "/terraform.tfstate",
        "titel": "Terraform State exponiert",
        "severity": Severity.KRITISCH,
        "beschreibung": "Terraform State enthaelt sensible Infrastruktur-Daten und Secrets.",
        "validate": lambda text: "terraform_version" in text.lower(),
    },
    {
        "path": "/swagger.json",
        "titel": "Swagger/OpenAPI Spezifikation exponiert",
        "severity": Severity.MITTEL,
        "beschreibung": "API-Dokumentation ist oeffentlich zugaenglich.",
        "validate": lambda text: '"swagger"' in text or '"openapi"' in text,
    },
    {
        "path": "/api-docs",
        "titel": "API-Dokumentation exponiert",
        "severity": Severity.MITTEL,
        "beschreibung": "API-Dokumentation ist oeffentlich zugaenglich.",
    },
    {
        "path": "/graphql",
        "titel": "GraphQL-Endpunkt gefunden",
        "severity": Severity.MITTEL,
        "beschreibung": "Ein GraphQL-Endpunkt ist oeffentlich zugaenglich (Introspection moeglich).",
    },
    {
        "path": "/.github/workflows/",
        "titel": "GitHub Workflows exponiert",
        "severity": Severity.NIEDRIG,
        "beschreibung": "CI/CD-Pipeline-Konfiguration ist zugaenglich.",
    },
    {
        "path": "/.gitlab-ci.yml",
        "titel": "GitLab CI Config exponiert",
        "severity": Severity.NIEDRIG,
        "beschreibung": "CI/CD-Pipeline-Konfiguration ist zugaenglich.",
    },
    {
        "path": "/actuator",
        "titel": "Spring Actuator exponiert",
        "severity": Severity.HOCH,
        "beschreibung": "Spring Boot Actuator Endpunkte sind oeffentlich zugaenglich.",
    },
    {
        "path": "/actuator/env",
        "titel": "Spring Actuator Environment exponiert",
        "severity": Severity.KRITISCH,
        "beschreibung": "Spring Actuator /env enthaelt Umgebungsvariablen mit Secrets.",
    },
    {
        "path": "/actuator/health",
        "titel": "Spring Actuator Health exponiert",
        "severity": Severity.NIEDRIG,
        "beschreibung": "Spring Boot Health-Endpunkt ist zugaenglich.",
    },
    {
        "path": "/docker-compose.yml",
        "titel": "Docker Compose Config exponiert",
        "severity": Severity.HOCH,
        "beschreibung": "Docker Compose Konfiguration kann Passwoerter und Infrastruktur-Details enthalten.",
        "validate": lambda text: "services:" in text or "version:" in text,
    },
    {
        "path": "/Dockerfile",
        "titel": "Dockerfile exponiert",
        "severity": Severity.MITTEL,
        "beschreibung": "Das Dockerfile gibt Build-Informationen und moeglicherweise Secrets preis.",
    },
    {
        "path": "/.npmrc",
        "titel": ".npmrc exponiert",
        "severity": Severity.HOCH,
        "beschreibung": "Die .npmrc kann npm-Registry-Tokens enthalten.",
    },
    {
        "path": "/config.yml",
        "titel": "YAML-Konfiguration exponiert",
        "severity": Severity.MITTEL,
        "beschreibung": "Eine YAML-Konfigurationsdatei ist oeffentlich zugaenglich.",
    },
    {
        "path": "/config.json",
        "titel": "JSON-Konfiguration exponiert",
        "severity": Severity.MITTEL,
        "beschreibung": "Eine JSON-Konfigurationsdatei ist oeffentlich zugaenglich.",
    },
    {
        "path": "/.well-known/security.txt",
        "titel": "security.txt vorhanden",
        "severity": Severity.INFO,
        "beschreibung": "Eine security.txt Datei ist vorhanden (gute Praxis fuer Responsible Disclosure).",
    },
    {
        "path": "/robots.txt",
        "titel": "robots.txt Details",
        "severity": Severity.INFO,
        "beschreibung": "robots.txt kann Hinweise auf versteckte Verzeichnisse geben.",
    },
    {
        "path": "/sitemap.xml.gz",
        "titel": "Komprimierte Sitemap gefunden",
        "severity": Severity.INFO,
        "beschreibung": "Eine komprimierte Sitemap ist zugaenglich.",
    },
    {
        "path": "/wp-config.php~",
        "titel": "WordPress-Config Editor-Backup exponiert",
        "severity": Severity.KRITISCH,
        "beschreibung": "Ein Editor-Backup der WordPress-Konfiguration ist zugaenglich.",
    },
    {
        "path": "/index.php.bak",
        "titel": "PHP-Backup-Datei exponiert",
        "severity": Severity.HOCH,
        "beschreibung": "Eine PHP-Backup-Datei kann Quellcode und Zugangsdaten enthalten.",
    },
    {
        "path": "/dump.sql",
        "titel": "SQL-Dump exponiert",
        "severity": Severity.KRITISCH,
        "beschreibung": "Ein SQL-Dump ist oeffentlich zugaenglich.",
    },
    {
        "path": "/.env.backup",
        "titel": ".env Backup exponiert",
        "severity": Severity.KRITISCH,
        "beschreibung": "Ein Backup der .env-Datei ist oeffentlich zugaenglich.",
        "validate": lambda text: "=" in text,
    },
    {
